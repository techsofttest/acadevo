!(function (e) {
                    ...
                    pagination: {
                        ...
                        renderBullet: function (e, t) {
                            ...
                            return i.length
                                ...
                                : '<span class="' + t + '" aria-label="Go to Slide ' + a + '"></span>';
                        },
                ...
                on: {
                    init: function () {
                        ...
                        for (let n = 0; n < t.slides.length; n++)
                            e(t.slides[n])
                                .find(".hero-img")
                                .attr({ "data-swiper-parallax": 0.75 * t.width, "data-swiper-parallax-opacity": 0.5 }),
                                e(t.slides[n])
                                    .find(".title")
                                    .attr("data-swiper-parallax", 0.65 * t.width),
                                e(t.slides[n])
                                    .find(".description")
                                    .attr("data-swiper-parallax", 0.5 * t.width);
                    },
                    resize: function () {
                        this.update();
                    },
                },
                navigation: { nextEl: ".parallax-slider .next-ctrl", prevEl: ".parallax-slider .prev-ctrl" },
            };
        (o = new Swiper(".parallax-slider", r)),
            e(window).on("resize", function () {
                o.destroy(), (o = new Swiper(".parallax-slider", r));
            });
    }
    ...
    var l = new Swiper(".hero5Thumbs", { spaceBetween: 3, slidesPerView: 1, freeMode: !0, watchSlidesProgress: !0 });
    l = new Swiper(".hero-slider-5", {
        thumbs: { swiper: l },
        loop: !0,
        effect: "fade",
    ...
    (e.fn.activateSliderThumbs = function (t) {
        ...
        e(".testi-box-tab").length &&
            e(".testi-box-tab").activateSliderThumbs({ sliderTab: !0, tabButton: ".tab-btn" });
    e(function () {
        e(".top-search form.header-search .box-search").each(function () {
            var t = e(this).find("input"),
                n = e(this).closest(".boxed").children(".overlay"),
                a = e(this).children(".search-suggestions");
            t.on("focus", function () {
                n.css({ opacity: "1", display: "block" }), a.css({ opacity: "1", visibility: "visible", top: "50px" });
            }),
                t.on("blur", function () {});
        }),
            e(document).on("click", function (t) {
                e(t.target).closest(".box-search").length ||
                    (e(".top-search .box-search .overlay").css({ opacity: "0", display: "none" }),
                    e(".top-search .box-search .search-suggestions").css({
                        opacity: "0",
                        visibility: "hidden",
                        top: "100px",
                    }));
    ...
    if (
        ...
        h(".popup-search-box", ".searchBoxToggler", ".searchClose", "show"),
        ...
        TweenMax.to({}, 0.016, {
            repeat: -1,
            onRepeat: function () {
                (m += (v - m) / 9), (g += (b - g) / 9), TweenMax.set(f, { css: { left: m - 12, top: g - 12 } });
            },
        }),
    ...
    const w = document.querySelector(".slider-drag-cursor"),
        y = { x: window.innerWidth / 2, y: window.innerHeight / 2 },
        C = { x: y.x, y: y.y },
        x = gsap.quickSetter(w, "x", "px"),
        k = gsap.quickSetter(w, "y", "px");
    function T(e) {
    ...
    window.addEventListener("pointermove", (e) => {
        ...
        gsap.ticker.add(() => {
            ...
            (y.x += (C.x - y.x) * e), (y.y += (C.y - y.y) * e), x(y.x), k(y.y);
        }),
        ...
        (e.fn.sectionPosition = function (t, n) {
            e(this).each(function () {
                ...
                (a = Math.floor(l.height() / 2)),
                    (s = l.attr(t)),
                    (i = l.attr(n)),
                    (o = T(e(i).css("padding-top"))),
                    (r = T(e(i).css("padding-bottom"))),
                    "top-half" === s
                        ? (e(i).css("padding-bottom", r + a + "px"), l.css("margin-top", "-" + a + "px"))
                        : "bottom-half" === s &&
                          (e(i).css("padding-top", o + a + "px"), l.css("margin-bottom", "-" + a + "px"));
            });
        });
    function M(t, n, a, s) {
        ...
        e(".filter-active").imagesLoaded(function () {
            ...
            e(".load-more-btn").on("click", function () {
                ...
                setTimeout(function () {
                    ...
                    0 === n.length && (n = a.closest(".container").find(".load-more-active")),
                        n.find(".filter-item.d-none, .accordion-card.d-none").removeClass("d-none");
                    e(t).isotope({ filter: "*" });
                }, 700);
            });
        }),
    ...
    if (
                ...
                var s = setInterval(function () {
                    ...
                    o < 10 && (o = "0" + o),
                        ...
                        i < 0
                            ...
                            : (a(".day").html(o), a(".hour").html(r), a(".minute").html(l), a(".seconds").html(c));
                }, 1e3);
            });
        }),
        ...
        const e = [].slice.call(document.querySelectorAll(".overlay-direction .filter-item"), 0),
            ...
            n = ["in", "out"].map((e) => Object.values(t).map((t) => `${e}-${t}`)).reduce((e, t) => e.concat(t)),
            a = (e, t) => {
                const { width: n, height: a, top: s, left: i } = t.getBoundingClientRect(),
                    o = e.pageX - (i + window.pageXOffset) - (n / 2) * (n > a ? a / n : 1),
                    r = e.pageY - (s + window.pageYOffset) - (a / 2) * (a > n ? n / a : 1);
                return Math.round(Math.atan2(r, o) / 1.57079633 + 5) % 4;
            };
        class s {
            constructor(e) {
                (this.element = e),
                    this.element.addEventListener("mouseover", (e) => this.update(e, "in")),
                    this.element.addEventListener("mouseout", (e) => this.update(e, "out"));
            }
            update(e, s) {
                this.element.classList.remove(...n), this.element.classList.add(`${s}-${t[a(e, this.element)]}`);
            }
        }
        e.forEach((e) => new s(e));
    }
    (e.fn.indicator = function () {
        ...
        e("#compslider").on("input change", (t) => {
            ...
            e(".foreground-img").css("width", n + "%"), e(".slider-button").css("left", `calc(${n}% - 32px)`);
        }),
